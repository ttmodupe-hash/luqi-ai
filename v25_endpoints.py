...
try:
    import backend.v25_luqi_endpoints as luqi_eps
    logger.info(
        "LUQI v25.1.1 endpoints registered: 15+ endpoints for agent, voice, memory, tools"
    )
except ImportError as e:
    logger.warning("LUQI v25.1.1 endpoints not loaded: %s", e)
