...
class InvestmentMining:
    ...
    # Approximate BTC network stats (mid-2026)
    BTC_DIFFICULTY = 95_000_000_000_000  # 95T
    BTC_BLOCK_REWARD = 3.125  # post-2024 halving
    BTC_HASHRATE_EHS = 850  # 850 EH/s global

    # ASIC catalog (real models with approximate specs)
    ...
    def mining_profitability(self, hash_rate_ths: float, power_cost_usd: float,
        ...
        daily_blocks = 144  # 6 per hour * 24
    ...
    def _get_cached_price(self, symbol: str) -> float:
        ...
        # Fallback mock prices (mid-2026 estimates)
